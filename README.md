...
## Deskripsi
Praktikum kali ini merupakan lanjutan dari praktikum sebelumnya, dengan fokus pada cara menghubungkan dua tabel dalam database menggunakan relasi One-to-Many. Selain itu, kita juga akan mempelajari cara menampilkan data yang saling berhubungan menggunakan Query Builder di CodeIgniter 4. Praktikum ini dilakukan menggunakan Laragon sebagai server lokal.

## Tujuan Praktikum

1. Mengetahui konsep dasar relasi antar tabel dengan model One-to-Many
...
4. Menampilkan informasi artikel lengkap dengan nama kategorinya
...
**Screenshot:**
![image](https://github.com/user-attachments/assets/9b9ee500-0ef1-4bf9-b219-9349e9b2495a)
...
**Screenshot:**
![image](https://github.com/user-attachments/assets/81b4a663-3a15-405a-b181-799efd70a2bd)
...
- Menerapkan method join melalui model
- Menyediakan fitur filter data berdasarkan kategori
- Mengelola input kategori pada form penambahan dan pengeditan artikel
...
![image](https://github.com/user-attachments/assets/13766065-5e61-46ee-abc4-80d90955a2c1)

2. Menambah Artikel Baru dengan Kategori
![image](https://github.com/user-attachments/assets/5a4aa806-73a8-4087-915e-b4ab25f59a55)
